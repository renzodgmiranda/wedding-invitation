...
const LIGHT_STYLES = [
    {
        label: 'Days',
        border: 'border-wedding-navy/30',
        accent: 'bg-wedding-navy',
...
const DARK_STYLES = [
    ...
    {
        label: 'Hours',
        border: 'border-wedding-gold/35',
        accent: 'bg-wedding-gold/80',
        number: 'text-wedding-ivory',
        box: 'bg-wedding-navy/40',
        labelColor: 'text-wedding-gold/80',
    },
    ...
    {
        label: 'Seconds',
        border: 'border-wedding-ivory/25',
        accent: 'bg-wedding-ivory/70',
        number: 'text-wedding-ivory',
        box: 'bg-wedding-navy/40',
        labelColor: 'text-wedding-gold/80',
    },
